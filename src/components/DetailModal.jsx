...
const DetailsModal = ({ item, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-center items-start pt-10 md:pt-20 bg-black/80 backdrop-blur-sm p-4 overflow-y-auto" onClick={onClose}>
      <div className="bg-zinc-900 w-full max-w-3xl rounded-xl shadow-2xl overflow-hidden relative mb-10 animate-in fade-in zoom-in-95 duration-300" onClick={e => e.stopPropagation()}>
        ...
        <div className="relative h-[300px] md:h-[400px]">
          ...
          <h2 className="absolute bottom-6 left-8 text-3xl md:text-5xl font-bold text-white drop-shadow-lg">{item.title}</h2>
        </div>
        ...
        <div className="p-8 md:flex gap-8">
          <div className="flex-1">
            ...
            <p className="text-lg text-gray-200 leading-relaxed mb-6">{item.desc}</p>
          </div>
          
          <div className="md:w-1/3 flex flex-col gap-4 text-sm text-gray-400">
