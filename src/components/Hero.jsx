...
const Hero = ({ onOpenDetails }) => {
  return (
    <section className="relative h-[80vh] min-h-[500px] flex items-center px-4 md:px-12">
      <div 
      ...
      <div className="max-w-2xl z-10 mt-16">
        <div className="flex items-center gap-2 text-red-600 font-bold text-sm tracking-[0.2em] mb-4">
          <span className="text-2xl leading-none">N</span> ORIGINAL DE OURFLIX
        </div>
        ...
        <p className="text-lg text-gray-200 mb-8 max-w-xl drop-shadow-md leading-relaxed">
        ...
        <div className="flex gap-4">
          <button 
            ...
            className="flex items-center gap-2 bg-white text-black px-6 py-3 rounded md:text-lg font-bold hover:bg-white/80 transition-colors"
          >
            <Play className="w-6 h-6 fill-current" /> Reproducir
          </button>
          <button className="flex items-center gap-2 bg-zinc-500/70 text-white px-6 py-3 rounded md:text-lg font-bold hover:bg-zinc-500/50 transition-colors">
