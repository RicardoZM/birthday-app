...
const TRIVIA_QUESTIONS = [
  ...
  },
  {
    ...
    options: ["A la playa", "A Asturias", "A la sierra de Madrid", "A Brea"],
    correct: 2,
    funFact: "Menudo Airbnb nos toco..."
  },
  {
    question: "¿Qué souvenir no puede faltar nunca cuando viajamos a una ciudad nueva?",
    options: ["Un imán para la nevera", "Una taza", "Un dedal", "Una postal"],
    correct: 2,
    funFact: "Hay que mantener la colección de mamá 😊."
  },
  {
    ...
    options: [
      ...
      "Que todo este milimétricamente  colocado",
  ...
  },
  {
    ...
    correct: 3,
    funFact: "Menos mal... Pense que no llegabamos vivos al hotel"
  },
  {
  ...
  {
    question: "¿Cuál fue el motivo real de dedicarle tantas horas a esta aplicación?",
    options: [
  ...
  {
    question: "De todos los lugares que hemos visitado o nos quedan por descubrir, ¿cuál es mi sitio favorito? (Cuidado que lleva trampa)",
    options: [
      "NYC 🗽",
      "Alemania 🍻",
    ...
    correct: 2,
    funFact: "Es la verdad: mi sitio favorito en el mundo no es una ciudad, es estar contigo. Siempre en mi equipo!! 💖"
  },
  {
  ...
  },
  {
    ...
    correct: 1,
    funFact: "Hace mucho que no te lo digo pero... Eres y serás una de las mejores oncologas de este país"
  },
  {
  ...
  },
  {
    ...
    options: [
      "Madrugar a las 6:00 para hacer una ruta de 20 kilómetros",
